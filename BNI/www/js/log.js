                       ...
                       // alert(result.rows.length);
                        for (var i = 0; i < result.rows.length; i++) {
                            var row = result.rows.item(i);
                               ...
                               if(logVisitor == 0){
                               $('#LogList').append('<ul><li class="wid6_l"><div class="plus">+</div></li><li class="wid1_l">'+logDate+'</li><li class="wid1_l">'+logTime+'</li><li class="wid2_l">'+logName+'</li><li class="wid4_l"><div class="check_box_l"><input type="checkbox" disabled = "disabled"/></div></li><li class="wid2_l">'+logAction+'</li><li class="wid2_l">'+balanceInDollaer+'</li><li class="wid2_l" style="border-right:none;">'+logPaidBy+'</li><li class="wid6_l"><div class="undo" onClick="divClosePressed((this.id))" id="'+row.log_id+'">x</div></li></ul>');
                               }else {
                               $('#LogList').append('<ul><li class="wid6_l"><div class="plus">+</div></li><li class="wid1_l">'+logDate+'</li><li class="wid1_l">'+logTime+'</li><li class="wid2_l">'+logName+'</li><li class="wid4_l"><div class="check_box_l"><input type="checkbox" disabled = "disabled" checked/></div></li><li class="wid2_l">'+logAction+'</li><li class="wid2_l">'+balanceInDollaer+'</li><li class="wid2_l" style="border-right:none;">'+logPaidBy+'</li><li class="wid6_l"><div class="undo" onClick="divClosePressed((this.id))" id="'+row.log_id+'">x</div></li></ul>');
                               }
