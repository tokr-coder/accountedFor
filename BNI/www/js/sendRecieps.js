...
function sendMemberSuccessAfterFetchingFromDb (){
   ...
   //http://127.0.0.1:8888/BNI/login.php
    //http://198.1.74.28/~spaniac1/bni/mail.php
     ...
     dataType: 'json',
     data: {"payment_method":paymentMethod , "products":descriptionString , "balance":memberBalanceToSend , "email_to":memberEmailToSend , "meeting_date":meetingTimeFromDB , "sold_to":memberNameToSend , "groupName":groupName , "emailSetupValue":emailSetupValue},
     timeout: 5000,
