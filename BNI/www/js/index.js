                            ...
                            if (result != null && result.rows != null) {
                                ...
                                for (var i = 0; i < result.rows.length; i++) {
                                    ...
                                    var activeOrNot =row.member_active;
                                         ...
                                         var MyDate= row.member_checkintime ;
                                    ...
                                    if(activeOrNot==1){
                                          ...
                                          if(lateORnot == 1){
                                          $('#MemberList').append('<ul><li class="wid1" style="color: red">'+ fullName +'</li><li class="wid2">'+ row.member_checkintime +'</li><li class="wid2" style="border-right:none;"><a style="color: #000000" href="payment.html?fromlink=ok&id='+ row.member_id+'">Paid</a></li></ul>');
                                          }else{
                                          $('#MemberList').append('<ul><li class="wid1">'+ fullName +'</li><li class="wid2">'+ row.member_checkintime +'</li><li class="wid2" style="border-right:none;"><a style="color: #000000" href="payment.html?fromlink=ok&id='+ row.member_id+'">Paid</a></li></ul>');
                                          }
                                          ...
                                          if(row.member_balance >= meetingFee) {
                                                ...
                                                $('#MemberList').append('<ul><li class="wid1">'+ fullName +'</li><li class="wid2"><input onClick="signInPressed((this.id))" type="button" class="login" value="Sign in" id="'+row.member_id+'"/></li><li class="wid2" style="border-right:none;"><a style="color: #000000" href="payment.html?fromlink=ok&id='+ row.member_id+'">Pre Paid</a></li></ul>');
                                          
                                          }else {
                                                $('#MemberList').append('<ul><li class="wid1">'+ fullName +'</li><li class="wid2"><input type="button" class="login" value="Sign In" disabled="disabled"/></li><li class="wid2" style="border-right:none;"><a href="payment.html?fromlink=no&id=' +row.member_id+'"><input type="button" class="login_pay" value="Pay &amp; Sign In"/></a></li></ul>');
                                          }
                   ...
                   transaction.executeSql('SELECT * FROM Members where member_id = ?', [clicked_id],function(transaction, result) {
                                          if (result != null && result.rows != null) {
                                             for (var i = 0; i < result.rows.length; i++) {
                                                ...
                                                db.transaction(function(transaction) {
                                                         transaction.executeSql('UPDATE Members SET  member_balance=? , member_checkintime=? , member_active=? where member_id = ?', [newMemberBalance,datetime,active,clicked_id],  addToLogAfterSignIn(fullName,newMemberBalance,clicked_id), errorCB);
                                                    },errorHandler,nullHandler);
...
function addToLogAfterSignIn(fullName,newMemberBalance,clicked_id) {
